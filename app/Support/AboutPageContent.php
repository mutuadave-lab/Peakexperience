    ...
    private static function pages(): array
    {
        ...
        return [
            [
                ...
                'image_alt' => 'Peak Experience event professionals welcoming conference delegates in Nairobi',
                'gallery_images' => [
                    asset('images/pages/conferences/stage-technical-production-1400.webp'),
                    asset('images/pages/conferences/guest-experience-1400.webp'),
                ],
                'event_date' => '',
            ...
            [
                ...
                'image_alt' => 'A diverse group of delegates participating in a professionally produced event in Kenya',
                'gallery_images' => [
            ...
            [
                ...
                'image' => asset('images/pages/exhibitions/exhibitions-hero-itw-reception.webp'),
                'image_alt' => 'Reusable branded exhibition environment produced for an event in Kenya',
                'gallery_images' => [
                    asset('images/pages/exhibitions/exhibitions-planning-1200.webp'),
                    asset('images/pages/conferences/stage-technical-production-1400.webp'),
                ],
                'event_date' => '',
            ...
            [
                ...
                'gallery_images' => [
                    ...
                    asset('images/pages/brand-experiences/immersive-launches-1200.webp'),
                ],
                'event_date' => '',
